...
struct OnBoardingPetFollowView: View {
...
struct OnBoardingPetFollowView_Previews: PreviewProvider {
    static var previews: some View {
        OnBoardingPetFollowView(PetMessage: "bruh")
    }
}
